...
class Train:
    ...
    def __init__(self, root):
        ...
        title_lbl = Label(self.root, text="TRAIN DATA SET", font=("time new roman", 25, "bold"),
                          bg="white", fg="red")
        ...
        , cursor="hand2", font=("time new roman", 30, "bold"), bg="red",
                        fg="white")
        b1_1.place(x=0, y=380, width=1530, height=60)

        img_bottom = Image.open(r"college_images/face_detection2x.png")
        img_bottom = img_bottom.resize((1530, 325), Image.LANCZOS)
        self.photoimg_bottom = ImageTk.PhotoImage(img_bottom)

        f_lbl = Label(self.root, image=self.photoimg_bottom)
        f_lbl.place(x=0, y=444, width=1530, height=325)
    ...
    def train_classifier(self):
        ...
        for image in path:
            img = Image.open(image).convert('L') #gray scale gray
