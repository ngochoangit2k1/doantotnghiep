    ...
    def face_recog(self):
        def draw_boundray(img, classifier, scaleFactor, minNeighbors,color, text,clf  ):
            ...
            for (x, y, w, h) in features:
                ...
                id,predict=clf.predict(gray_image[y:y+h, x:x+w])# dự đoán đối tượng trong hình chữ nhật trên kết qảu dự đoán lưu trên id và phần trăm giống lưu trên predict
